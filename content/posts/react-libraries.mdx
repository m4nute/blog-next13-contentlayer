---
title: ⚛️ Game Changing React Libraries
...
For animations, Framer Motion is versatile, but its documentation can be challenging to grasp. Animate On Scroll is suitable for scroll animations. CSS is the most comprehensive option but requires more expertise. I don't have a personal favorite; it's best to experiment and find what suits you.
...
Now that Next.js 13.4 dropped and it's production ready, I'd recommend create-next-app for creating your Next.js apps. You can also use create-t3-app for a more complete installation (Prisma, TRPC, etc).
...
Might be the next big thing. For now I wouldn't use it, since it's still in beta and the docs are incompleted.
...
This is a data fetching library supported by Vercel. Even tough it's really good, I prefer TanStack Query because it's more complete, but SWR is probably the closest alternative to it.
...
This one is really good, almost a must. It's simple, flexible and saves you from having to create a state for each field, write errors and make a regex for the email. It does it all for you. It's compatible with Zod, for an easier type validation.
